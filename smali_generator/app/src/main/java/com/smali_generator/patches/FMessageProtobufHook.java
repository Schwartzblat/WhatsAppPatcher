        ...
        try {
            ...
            if (protocol_message.object != null) {
                if ((int)protocol_message.get("type_") == 0) {
                    ...
                    params.set(E2EMessageParams.isQuoted, true);

                    message.set(WhatsAppProtobufMessage.bitField0_, 67108896);
                    ...
                    messageContextInfo.set(MessageContextInfo.bitField0_, 8199);
...
//                    quoted_message.set(WhatsAppProtobufMessage.bitField0_, 67108865);
                    ...
                    String participant = (String) messageKey.get(MessageKey.participant_);
                    if (participant == null || participant.isEmpty()) {
                        participant = (String) messageKey.get(MessageKey.remoteJid_);
                    }
                    contextInfo.set(ContextInfo.participant_, participant);
...
//                    contextInfo.set(ContextInfo.quotedMessage_, quoted_message.object);
        ...
        return generate_fmessage_backup(self, e2EMessageParams);
    }
